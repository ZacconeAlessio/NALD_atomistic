...
The affine force field is generated by applying a very small affine shear deformation to the atomistic configuration and measuring the resulting forces. Please check the LAMMPS input script in.AF
...
If you use this repository or the atomistic NALD methodology in scientific work, please cite:
